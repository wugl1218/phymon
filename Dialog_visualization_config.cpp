...
#include "ui_Dialog_visualization_config.h"

Dialog_visualization_config::Dialog_visualization_config(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::Dialog_visualization_config)
{
    ui->setupUi(this);
...
Dialog_visualization_config::~Dialog_visualization_config()
{
    delete ui;
}/*
void Dialog_visualization_config::step()
{
