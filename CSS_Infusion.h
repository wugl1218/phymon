...
class CSS
{
    ...
    QString Enabled_Checked_ButtonStyle   ="QPushButton {font-style:\"Arial\";color:rgb(61, 56, 70);background-color:rgb(11, 42, 78);border-style: solid;border-width:1px;border-radius:20px;border-color:  rgb(11, 42, 78);border:2px groove gray;padding:10px 8px;;border: none;}QPushButton:checked{background-color: rgb(11, 42, 78);};";
    QString Enabled_unChecked_ButtonStyle ="QPushButton {font-style:\"Arial\";color:rgb(61, 56, 70);background-color:rgb(8, 98, 202);border-style: solid;border-width:1px;border-radius:20px;border-color:  rgb(11, 42, 78);border:2px groove gray;padding:10px 8px;;border: none;}QPushButton:checked{background-color: rgb(11, 42, 78);};";
    QString Checked_ButtonStyle           ="QPushButton {font-style:\"Arial\";color:rgb(255, 255, 255);background-color:rgb(11, 42, 78);border-style: solid;border-width:1px;border-radius:20px;border-color:  rgb(11, 42, 78);border:2px groove gray;padding:10px 8px;;border: none;}QPushButton:checked{background-color: rgb(11, 42, 78);};";
    QString unChecked_ButtonStyle         ="QPushButton {font-style:\"Arial\";color:rgb(255, 255, 255);background-color:rgb(8, 98, 202);border-style: solid;border-width:1px;border-radius:20px;border-color:  rgb(11, 42, 78);border:2px groove gray;padding:10px 8px;;border: none;}QPushButton:checked{background-color: rgb(11, 42, 78);};";
