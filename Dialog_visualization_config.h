#ifndef DIALOG_VISUALIZATION_CONFIG_H
#define DIALOG_VISUALIZATION_CONFIG_H
...
namespace Ui {
class Dialog_visualization_config;
}

class Dialog_visualization_config : public QDialog
{
    Q_OBJECT

public:
    explicit Dialog_visualization_config(QWidget *parent = nullptr);
    ~Dialog_visualization_config();
    void step();

private:
    Ui::Dialog_visualization_config *ui;
    int jumper_state;
    int jumper_highest;
    int jumper_higher;
    int jumper_lower;
...
#endif // DIALOG_VISUALIZATION_CONFIG_H
