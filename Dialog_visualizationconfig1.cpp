#include "Dialog_visualizationconfig.h"
#include "ui_Dialog_visualizationconfig.h"

Dialog_visualizationconfig::Dialog_visualizationconfig(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::Dialog_visualizationconfig)
{
    ui->setupUi(this);
...
Dialog_visualizationconfig::~Dialog_visualizationconfig()
{
    delete ui;
}/*
void Dialog_visualizationconfig::step()
{
