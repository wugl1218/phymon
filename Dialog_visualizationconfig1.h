#ifndef DIALOG_VISUALIZATIONCONFIG1_H
#define DIALOG_VISUALIZATIONCONFIG1_H
...
namespace Ui {
class Dialog_visualizationconfig;
}

class Dialog_visualizationconfig : public QDialog
{
    Q_OBJECT

public:
    explicit Dialog_visualizationconfig(QWidget *parent = nullptr);
    ~Dialog_visualizationconfig();
    void step();

private:
    Ui::Dialog_visualizationconfig *ui;
    int jumper_state;
    int jumper_highest;
    int jumper_higher;
    int jumper_lower;
...
#endif // DIALOG_VISUALIZATIONCONFIG1_H
