...
public:
    ...
    void add_frame_control();
    void set_loop_minus(mc_btn_Clickable *loop_minus, mc_btn_Clickable *add_btn)
    {
        m_loop_minus = loop_minus;
        m_add_btn = add_btn;
    };
signals:
...
private:
    ...
    void push_add_item(bool bAddDel = false, bool bAllListed = false);
